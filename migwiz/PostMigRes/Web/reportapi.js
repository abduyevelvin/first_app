                                 ...
                                 )
{
    ...
    new_html += '        <TR>';
    new_html += '            <TD width="10%" valign="top">';
    new_html += '                <TABLE width="100%" border="0" cellspacing="0" cellpadding="0">';
    new_html += '                    <TR>';
    ...
    new_html += '                            <IMG src="'+app_icon_directory+'/'+icon+'" name="'+item+'_icon" valign="middle"></IMG>';
    new_html += '                        </TD>';
    new_html += '                    </TR>';
    new_html += '                </TABLE>';
    new_html += '            </TD>';
    new_html += '            <TD width="75%" valign="top">';
    new_html += '                <TABLE width="100%" border="0" cellspacing="0" cellpadding="0" id="'+item+'_body">';
    new_html += '                    <TR>';
    new_html += '                        <TD valign="top" width="59%" id="'+item+'_name_display">';
    new_html += '                            <DIV style="font-size:77%;font-family:Segoe UI;color:#000000;font-weight:bold">'+name+'</DIV>';
    new_html += '                        </TD>';
    new_html += '                        <TD width="2%"></TD>';
    new_html += '                        <TD valign="top" width="39%" id="'+item+'_publisher_display">';
    ...
    new_html += '                    </TR>';
    new_html += '                    <TR>';
    new_html += '                        <TD colspan="3" id="'+item+'_information_display">';
                               ...
                               )
{
    ...
    new_html += '    <TABLE width="100%" border="0" cellspacing="0" cellpadding="0" id="'+item+'_body">';
    new_html += '        <TR>';
    new_html += '            <TD valign="middle" width="9%" rowspan="2">';
    new_html += '                <IMG src="'+api_directory+'base_images/'+icon+'" width="80%"></IMG>';
    new_html += '            </TD>';
    new_html += '            <TD valign="middle" width="2%" rowspan="2">';
    new_html += '            </TD>';
    new_html += '            <TD valign="middle">';
